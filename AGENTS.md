...
- **SHA256 verification**: OWASP CRS tarball (v4.29.0) and coraza.conf (v3.7.0, via `CORAZA_CONF_SHA256` ARG) verified against pinned SHA256 checksums at build time
