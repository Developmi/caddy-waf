...
- **Vulnerability scanning**: Both architectures (`linux/amd64` and `linux/arm64`) are scanned with Trivy before pushing. CRITICAL and HIGH vulnerabilities on either architecture block the pipeline.
...
|----------|--------------------|----------|
| `CVE-2026-84304` | google.golang.org/grpc v1.82.1 (embedded in Caddy binary) | grpc v1.83.2 (coraza-caddy v2.6.1) |
| `CVE-2026-84445` | google.golang.org/grpc v1.82.1 (embedded in Caddy binary) | grpc v1.83.2 (coraza-caddy v2.6.1) |
...
| **2026-09-21** | caddy-waf **v3.5.3** released - coraza-caddy v2.6.1 (flush/hijack fixes, grpc v1.83.2 resolves CVE-2026-84304 and CVE-2026-84445, empty .trivyignore) |
